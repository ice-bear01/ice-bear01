...
import { ref } from 'vue'
import AllWindows from './ProductType/AllWindows.vue'

const currentWindowsComponent = ref<any>(AllWindows)
const searchWindows = ref('')
const selectedType = ref('All')
const windowTypes = ['All', 'Sliding', 'Casement', 'Awning', 'Fixed']
...
<template>
  <div class="flex flex-col gap-10 p-6 sm:p-10">
    ...
    <div class="flex flex-col gap-3 text-center">
      <p class="font-bold text-3xl sm:text-4xl text-white">Windows</p>
      <p class="max-w-xl mx-auto text-white/80 text-sm sm:text-base">
        Explore our extensive collection of premium glass and aluminum windows.
      </p>
    </div>
    ...
    <div class="w-full mt-4">
      <component
        :is="currentWindowsComponent"
        :search-query="searchWindows"
        :selected-type="selectedType"
        :key="currentWindowsComponent"
      />
    </div>
  </div>
</template>
...
<style scoped>
/* Make dropdown usable on very small screens */
