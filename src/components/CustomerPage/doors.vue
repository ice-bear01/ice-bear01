...
import { ref } from 'vue';
import AllDoors from './ProductType/AllDoors.vue';

const currentDoorsComponent = ref<any>(AllDoors);
const searchDoors = ref('');
const selectedType = ref('All');

const doorTypes = ['All', 'Sliding', 'Swing', 'Folding', 'Bifold'];
...
<template>
  <div class="flex flex-col gap-10 p-6 sm:p-10">
    ...
    <div class="w-full mt-4">
      <component
        :is="currentDoorsComponent"
        :search-query="searchDoors"
        :selected-type="selectedType"
        :key="currentDoorsComponent"
      />
    </div>
  </div>
</template>
